...
route.post('/products', (req, res) => {
    ...
    connection.query(
        query,
        [req.body.Vendor_ID, req.body.product_name, req.body.product_price, req.body.qty_kilos, req.body.qty_dozen, req.body.expiry_date, req.body.product_image, req.body.discount, req.body.category, 0],
        function (err, results) {
            res.send(results || err)
        }
    )
